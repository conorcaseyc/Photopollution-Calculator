...
#The Data
population_density = array([2.4, 1205.4, 1351.3, 1636.4, 748.5, 1254, 1064, 1892, 3300, 1230.3, 658, 821.6, 1286.6, 1387.5, 1591.2, 1292, 1423.6, 1206.6, 1796.3, 768.5])
population = array ([146, 4979, 3593, 17140, 138, 1374, 946, 1346, 119320, 3765, 540, 3287, 25276, 9729, 94192, 1129, 6619, 23691, 14504, 2175])
...
stddev = std(lux)
errorbar(population_density, lux, stddev, color='g', linestyle='None')
show()
...
firsttrip_pd = array([2.4, 1205.4, 1351.3, 1636.4, 748.5, 1254, 1064, 1892, 3300, 1230.3])
...
kerry_pd = array([2.4, 658, 1206.6, 1796.3, 768.5])
...
stddev = std(max_lux)
errorbar(population_density, max_lux, stddev, color='g', linestyle='None')
show()
#Min LUX Graph
...
stddev = std(min_lux)
errorbar(population_density, min_lux, stddev, color='g', linestyle='None')
show()
...
text(0,100, "r = " + str(round(correlation, 3)))
stddev = std(firsttrip_pp)
errorbar(firsttrip_pd, firsttrip_pp, stddev, color='g', linestyle='None')
show()
...
stddev = std(secondtrip_pp)
errorbar(secondtrip_pd, secondtrip_pp, stddev, color='g', linestyle='None')
show()
...
stddev = std(kerry_pp)
errorbar(kerry_pd, kerry_pp, stddev, color='g', linestyle='None')
show()
#Tipperary Graph
...
stddev = std(tipp_pp)
errorbar(tipp_pd, tipp_pp, stddev, color='g', linestyle='None')
show()
#Waterford Graph
...
stddev = std(water_pp)
errorbar(water_pd, water_pp, stddev, color='g', linestyle='None')
show()
#Cork Graph
...
stddev = std(cork_pp)
errorbar(cork_pd, cork_pp, stddev, color='g', linestyle='None')
show()
#Clare Graph
...
stddev = std(clare_pp)
errorbar(clare_pd, clare_pp, stddev, color='g', linestyle='None')
show()
#Limerick Graph
...
stddev = std(lim_pp)
errorbar(lim_pd, lim_pp, stddev, color='g', linestyle='None')
show()
