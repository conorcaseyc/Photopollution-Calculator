...
Updates:
v0.10: Initial beta version based on the mathematical model from the SciFest
project called "How Population Density Influences Light Pollution".
v0.11: Allowed population density figures to be inputted.
v0.50: The mathematical model is updated, and is now based on the 
...
v0.51: Includes licensing agreement.
v0.52: Updated population density figures to include the figures from the 
2016 Census.
v0.53: See those bugs, no? Well, they are gone!
v0.54: Slight changes to the mathematical model.
v0.60: Slight changes to the grading system and mathematical model.
v0.61: Fixed TypeError when entering a text value for population density.
v0.62: See those bugs, no? Well, they are gone!
v0.63: Updated to support Windows and macOS alongside Linux.
v1.00: Worldwide Public Release on Github! 

Current Edition: v1.00"""
